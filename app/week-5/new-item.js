...
export default function NewItem() {
  ...
  return (
    <form className="flex flex-col space-y-4 max-w-72 mx-auto mt-8">
      <div className="flex items-baseline justify-between space-y-2">
        <label className="w-20 text-end text-gray-300 font-bold">Name:</label>
        <input
          type="text"
          id="name"
          value={name}
      ...
      <div className="flex items-baseline justify-between space-y-2">
        <p className="w-20 text-end text-gray-300 font-bold">Quantity:</p>
      ...
      <div className="flex items-baseline justify-between space-y-2">
        <label className="w-20 text-end text-gray-300 font-bold">
          Category:
        </label>
        <select
          value={category}
